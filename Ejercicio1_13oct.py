...
#PRIMERA IMAGEN ESCALAR FACTOR 2, APLICAR FILTRO BILINEAL
...
#filtro bilateral
imagen_bilinear = cv.bilateralFilter(imagen_escalada,9,100,100)
...
# Centro de la imagen original y del nuevo lienzo
cx, cy = x // 2, y // 2
